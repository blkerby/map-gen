...
- Keep efficiency in mind. Avoid unnecessary redundancy in computations, by
  precomputing and reusing values when possible.
...
- If the worktree is dirty when beginning a new task involving writing to the
  project, stop and let the user know, as they may want to commit the work first.
