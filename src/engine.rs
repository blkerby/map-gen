...
impl EnvironmentGroup {
    ...
    fn get_sparse_features<'py>(
        ...
        Ok((
            pyarray2_from_flat_vec(py, inventory, environment_count, inventory_width)?,
            pyarray2_from_flat_vec(py, room_x, environment_count, room_width)?,
